                    ...
                    <div className="absolute top-[0px] left-[0px] w-[624px] h-[617px]">
                        ...
                        <div className="absolute top-[101px] left-[0px] w-[624px] h-[516px]">
                            <span className="absolute top-[0px] left-[0px] text-black w-[624px] h-[36px] opacity-60"
                                ...
                                Job: AI developer, Leader
                            </span>
                            <span className="absolute top-[60px] left-[0px] text-black w-[624px] h-[72px] opacity-60"
                                style={{ fontSize: "24px", fontWeight: 400 }}>
                                Training model, Back-end developing and merging with Front-end
                            </span>
                            ...
                            <span className="absolute top-[276px] left-[0px] text-black w-[624px] h-[36px]"
                                style={{ fontSize: "24px", fontWeight: 400 }}>
                                Description: <br />
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam vulputate, lorem ac elementum convallis, ligula dolor dignissim eros, eu eleifend tellus libero vitae massa. Maecenas et vestibulum nunc, et efficitur enim. Nam tempus dapibus molestie. Integer vestibulum fringilla orci at gravida.
                            </span>
                        </div>
                    </div>
                </div>
